...
Reposition `roomci` from a hospitality-focused smart-home portfolio piece into a generic MQTT / edge / building-automation QA contract emulator while preserving the hospitality-focused depth as a hospitality domain pack.

The product should read as useful to smart-home, building-automation, facility-ops, BMS/EMS, and MQTT-based edge-device teams, not only as a hospitality interview artifact.
...
- Keep hospitality interview docs as a domain-specific narrative, not the product's only identity.
...
- hospitality content is preserved under interview/domain docs, not used as the only product frame.

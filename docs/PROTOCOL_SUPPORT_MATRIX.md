...
| BMS / operations alerts | `scenario_model` | `crates/roomci-ops`, `examples/bms_sauna_emergency_alert.yaml`, `docs/10_bms_operations_emulation.md`, ops tests | No external webhook/API endpoint yet | Alert sources, severity, notification routing, ticket lifecycle, acknowledgement contract, runbook URLs | Production BMS, real Slack/phone/ticket integrations, incident-response guarantee |
